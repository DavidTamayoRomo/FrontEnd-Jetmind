...
export class RepresentanteComponent implements OnInit {
  ...
  async cargarRepresentantebyId(id: string) {
    ...
    this.representanteService.obtenerRepresentanteById(id)
      .subscribe((resp: any) => {
  ...
  crearRepresentante(){
    ...
    if (this.representanteSeleccionada) {
      ...
      if (this.registerForm.invalid) {
        ...
        this.representanteService.updateRepresentante(this.representanteSeleccionada._id, this.RepresenteModel).subscribe((resp: any) => {
          const Toast = Swal.mixin({
            toast: true,
            position: 'top-end',
            showConfirmButton: false,
      ...
      if (this.registerForm.invalid) {
        ...
        this.representanteService.crearRepresentante(this.registerForm.value).subscribe((resp) => {
